...
$key_css_normal2 = $key_js_normal2 = "";
...
foreach ($keyfiles_list as $file_ext) {
    ...
    if ($file_ext_final == "js") {
        $key_js_normal2 = <<<EOD
<script src="https://cdnjs.cloudflare.com/ajax/libs/$director/$version_number/$file_ext"></script>

EOD;
    }
    if ($file_ext_final == "css") {
        $key_css_normal2 = <<<EOD
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/$director/$version_number/$file_ext" media="all">
EOD;
    }
}
...
<div id="page">
    ...
    <main class="main ">
        <article class="cdn-release <?php if (isset($latest_v)) { ?> live <?php } ?>">
            <header class="article-head">
                ...
                <div class="container-large">
                    ...
                    <div class="meta-holder">
                        <ul class="meta">
                            <li title="<?php if (isset($latest_v)) { ?>Current <?php } ?> Version: <?php echo $version_number; ?>">
                                <span><i class="icon-layers"></i><?php echo $version_number; ?></span></li>
                            <li class="download"><a target="_blank" href="#download"><i class="icon-download"></i>Download</a>
                            </li>
                            <?php if (isset($latest_v)) { ?>
                                <li><a href="../<?php echo $foldername . '@' . $version_number; ?>/"><i
                                                class="icon-cloud"></i>Get Version Based</a></li>
                            <?php } ?>
                        </ul>
                        <ul class="meta">
                            <?php
                            if (isset($github)) {
                                if (!empty($github)) {
                                    ?>
                                    <li><a rel="nofollow" class="btnGit" target="_blank"
                                           href="<?php echo $github; ?>"><i class='icon-github'></i>Github</a></li>
                                <?php }
                            } ?>
                            <?php if (isset($npmrg)) { ?>
                                <?php if (!empty($npmrg)) { ?>
                                    <li><a class="btnNPM" rel="nofollow" target="_blank"
                                           href="https://www.npmjs.com/package/<?php echo $npm_s; ?>"><i
                                                    class="icon-npm1"></i>NPM JS</a></li>
                                <?php }
                            } ?>
            ...
            <div class="content-holder container-large sticky-smart-placeholder">
                <div class="content-twocols">
                    <div class="content-block">
                        <?php if (isset($latest_v)) { ?>
                            <div class="alert-catuion">
                                <i class="icon-warning"></i>
                                <div class="text-box">
                                    <p>Live First CDN files will be automatically update on same URL with latest stable
                                        version files for this plugin.</p>
                                    <p>We do not recommend Live First version for production use.</p>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="block" id="keyfiles">
                            <?php if (isset($latest_v)) { ?>
                                <h2><i class="icon-one"><img src="<?php echo $base_url ?>images/icon-one.svg" width="30"
                                                             alt="Live First Icon"></i><?php echo $title; ?> One Click Installation</h2>
                                <p>A quick way to install <?php echo $title ?> to your website.<br>
                                    Copy <a href="javascript:" data-clipboard-text='<?php if (isset($latest_v)) {
                                        echo $key_js_live . $key_css_live;
                                    } else {
                                        echo $key_js_normal . $key_css_normal;
                                    } ?>' class="btn-text copycat <?php if (isset($latest_v)) { ?>  btncopy-live <?php } else { ?>  btncopy-normal <?php } ?>">all key files</a> with one click or copy necessary
                                    files cdn one by one given below:</p>
                            <?php } else { ?>
                                <h2><i class="icon-one"><img src="<?php echo $base_url ?>images/icon-one.svg" width="30"
                                                             alt="Live First Icon"></i><?php echo $title . " " . $folderver; ?>
                                    Quick Installation</h2>
                                <p>A quick way to <?php echo $title . " " . $folderver; ?> implement to your
                                    website.<br>
                                    Copy <a href="javascript:" data-clipboard-text='<?php if (isset($latest_v)) {
                                        echo $key_js_live . $key_css_live;
                                    } else {
                                    ...
                                    files cdn one by one given below:
                                </p>
                            <?php } ?>
                            <div class="path">
                                <?php
                        ...
                        <div class="block" id="liveFirst">
                            <h2><i><img src="<?php echo $base_url ?>images/icon-live.svg" width="30"
                                        alt="Live First Icon"></i> <?php echo $title; ?> Live First CDN</h2>
                            <p><?php echo $title; ?> Live First CDN will be automatically update to the latest versions
                                on the same CDN resource. Live First CDN saves your time and you don't need to update
                                file version or change path in your website all the time.</p>
                            <?php } else { ?>
                            <div class="block" id="cdn">
                                <h2><i><img src="<?php echo $base_url; ?>images/icon-version.svg" width="30"
                                            alt="Cloud Icon"></i> <?php echo $title . " " . $folderver; ?> CDN</h2>
                                <p><?php echo $title; ?> <?php echo $folderver; ?> CDN resources for all
                                    their <?php echo $js_text . " " . $orcss; ?> files along with minified versions.</p>
                                    ...
                                    <div class="btn-holder">
                                        <?php if (isset($scss_folder) or isset($less_folder) or !empty($the_dir)) { ?>
                                            <?php if (file_exists("../../zip/$foldername.zip")) { ?>
                                                <a href="../../zip/<?php echo $foldername ?>.zip" class="btn btn-dark">Download
                                                    Files (<?php if (isset($js_exists)) {
                                                        echo "JS ";
                                                    } ?> <?php if (isset($css_exists)) { ?><?php if (isset($js_exists)) {
                                                        echo "- ";
                                                    } ?>CSS <?php } ?>

                                                    <?php if (isset($scss_exists)) { ?>- SCSS <?php } ?> <?php if (isset($less_exists)) { ?> - Less <?php } ?> <?php if (isset($json_exists)) { ?> - JSON <?php } ?> <?php if (isset($cdn_real_fonts)) {
                                                        echo "- Fonts";
                                                    } ?> <?php if (!empty($the_dir)) {
                                                        echo "& SCSS/LESS";
                                                    } ?>)</a>
                                            <?php } ?>
                                        ...
                                        <?php if (isset($scss_file_ex) or isset($less_file_ex) or isset($cdn_real_fonts) or isset($cdn_real_img)) { ?>
                                            <a href="javascript:" class="btn-show"><span
                                                        class="show">+ Show all files</span><span class="less">- Show less files</span></a>
                            ...
                            <div class="block" id="node">
                                ...
                                <?php if (!empty($npmrg)) { ?>
                                    <div class="path">
                                        <h3>How to install <?php echo $title . " " . $folderver; ?> with NPM<span>Install NodeJS and copy below text in Command:</span>
                                        </h3>
                                        <div class="code-line np">
                                            <code title="Click to Copy" class="copycat"
                                                  data-clipboard-text="npm i <?php echo $npm_s; ?><?php if (!isset($latest_v)) {
                                                      echo '@' . $folderver;
                                                  } ?>">&rsaquo; npm
                                                i <?php echo $npm_s; ?><?php if (!isset($latest_v)) {
                                                    echo "@" . $folderver;
                                                } ?></code>
                                            <div class="copy-cat">
                                    ...
                                    <div class="path">
                                        <h3>How to install <?php echo $title . " " . $folderver; ?> with Yarn<span>Install NodeJS and copy below text in Command:</span>
                                        </h3>
                                        <div class="code-line np">
                                            <code title="Click to Copy" class="copycat"
                                                  data-clipboard-text="yarn add <?php echo $npm_s; ?><?php if (!isset($latest_v)) {
                                                      echo '@' . $folderver;
                                                  } ?>">&rsaquo; yarn
                                                add <?php echo $npm_s; ?><?php if (!isset($latest_v)) {
                                                    echo '@' . $folderver;
                                                } ?></code>
                                            <div class="copy-cat">
                                                <button class="btn-coppier btn-red"><i class="icon-copy"></i></button>
                                ...
                                <?php if (!empty($github)) { ?>
                                    <div class="path">
                                        <h3>How to install <?php echo $title; ?> with Github <span>Use SVN or GIT to checkout using below URL: </span>
                                        </h3>
                                        <div class="code-line np">
                                            <code title="Click to Copy" class="copycat"
                                                  data-clipboard-text="<?php echo $github; ?>">&rsaquo; <?php echo $github; ?></code>
                                            <div class="copy-cat">
                                                <button class="btn-coppier btn-red"><i class="icon-copy"></i></button>
                                            </div>
                                        </div>
                            ...
                            <div class="block" id="download">
                                <h2><i class="icon-download"></i> Download <?php echo $title . " " . $folderver;
                                    if (isset($latest_v)) {
                                        echo "Latest";
                                    } ?> Source Files</h2>
                                <p>Download <?php if (isset($latest_v)) {
                                        echo "Latest";
                                    } ?> <?php echo $title . " " . $folderver ?> Source DIST
                                    Files<?php if (isset($npmrg)) { ?>, NPM <?php } ?> <?php if (isset($github)) {
                                        if (!empty($github)) { ?>or Github <?php }
                                    } ?> packages in ZIP.</p>
                                <div class="btn-area">
                                    <?php if (file_exists("../../zip/$foldername.zip")) { ?>
                                        <a target="_blank" href="../../zip/<?php echo $foldername ?>.zip"
                                           class="btn btn-dark"><i
                                                    class="icon-code-fork"></i>Download <?php echo $title;
                                            if (!isset($latest_v)) {
                                                echo "@" . $folderver;
                                            } ?>
                                            DIST
                                            (<?php echo $js_text; ?> <?php if (isset($css_exists)) { ?><?php if (isset($js_exists)) {
                                                echo " - ";
                                            } ?>CSS <?php } ?>
                                            <?php if (isset($scss_exists)) { ?>- SCSS <?php } ?> <?php if (isset($less_exists)) { ?> - Less <?php } ?> <?php if (isset($json_exists)) { ?> - JSON <?php } ?>
                                            Files)</a>
                                    <?php } ?>
                                    <?php if (isset($npmrg)) { ?>
                                        <a target="_blank" rel="help" href="<?php echo $npmrg . $version_number ?>.tgz"
                                           class="btn btn-dark btn-npm"><i
                                                    class="icon-npm1"></i>Download <?php echo $title . "@" . $version_number; ?>
                                            NPM Package</a>
                                    <?php }
                                    if (isset($github)) {
                                        if (!empty($github)) {
                                            if (!empty($gitrg)) { ?>
                                                <a target="_blank" rel="help"
                                                   href="<?php echo $gitrg . $version_number ?>.tar.gz"
                                                   class="btn btn-dark btn-git"><i
                                                            class="icon-github"></i>Download <?php echo $title . "@" . $version_number; ?>
                                                    Github Package</a>
                                            <?php } else {
                                                if (!isset($gitmaster)) {
                                                    $gitmaster = $github;
                                                ...
                                                ?>
                                                <a target="_blank" rel="help"
                                                   href="<?php echo $gitmaster ?>/archive/<?php echo $github_archive_path; ?>.zip"
                                                   class="btn btn-dark btn-git"><i class="icon-github"></i>Download
                                                    Github Master</a>
                                            <?php }
                                        }
                                    } ?>
                        ...
                        <aside class="aside">
                            <div class="aside-holder sticky-smart-demo">
                                    ...
                                    <div class="btn-block">
                                        <?php if (isset($latest_v)) { ?>
                                            <button title='Copy all necessary CDN Sources for implementation'
                                                    ...
                                                    type="button" class="btn btnLive btncopy-live copycat">
                                                <i class="icon-live"></i> <span>Copy Key Files <small>Live First</small></span>
                                            </button>
                                        <?php } ?>
                                        <button title='Copy all necessary CDN Sources for implementation'
                                                data-clipboard-text='<?php echo $key_js_normal2 . $key_css_normal2; ?>'
                                                type="button" class="btn btncopy-normal copycat">
                                            <i class="icon-cloud"></i> <span>Copy Key Files <small>Version Based</small></span>
                                        </button>
                                        <?php if (file_exists("../../zip/$folderexit.zip")) { ?>
                                            <a href="../../zip/<?php echo $folderexit ?>.zip"
                                               class="btn copycat btnZip">
                                                <i class="icon-zip"></i> <span>Download <small>Zip</small></span></a>
                                        <?php } ?>
                                    </div>
                                    <strong class="notice"
                                            title="Copy All necessary <?php echo $title . " " . $folderver; ?> CDN Sources with ONE Click">One
                                        Click Implementation</strong>
                                </section>
                                <?php /*
                                ...
                                <section class="widget">
                                    <h2>All Versions</h2>
                                    <ul class="versions">
                                        <li class="<?php if ($director == $foldername) {
                                            echo "active";
                                        } ?>"><a href="../<?php echo $director ?>/"><?php echo $director ?> (Live First
                                                CDN)</a></li>
                                        <?php foreach ($v_h as $version_) {
                                            $version_ = str_replace(".zip", '', $version_);
                                            ?>
                                            <li class="<?php if ($version_ == $foldername) {
                                                echo "active";
                                            } ?>"><a href="../<?php echo $version_; ?>/"><?php echo $version_ ?> </a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </section>
